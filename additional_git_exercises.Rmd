...
That seems neater, but keep in mind that if you'd pushed `master` to github while those commits were there, anyone else who had built on your repo would have lots of trouble.  The `revert` approach makes for messier history, but has the advantage that it doesn't disconnect anyone else.
