...
skills_topics <- tribble(
  ...
  "Machine Readable Creative Commons Licenses", "CC web tools and xml", "https://wiki.creativecommons.org/wiki/Marking_your_work_with_a_CC_license and https://wiki.creativecommons.org/wiki/Best_practices_for_attribution"
) %>% rownames_to_column()
