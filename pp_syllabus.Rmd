...
### Peer production participation and presentation

Students will identify and participate in an active peer production community of their choosing. If you are already involved in a peer production project you may use that, but most will be entering afresh. There are three graded components, each to be submitted via a pull request.
...
skills_topics <- tribble(
  ~skill_topic, ~tech_commands, ~materials,
  #-------------------------------------
  "Tech setup workshop", "terminal, command line, git install, github account", "",
  "Files. diffs, versions", "git diff, add, commit (locally)", "DataCamp Git Chapter 1 - Basic Workflow",
  "Servers and sharing work", "github fork, git clone, push, pull request", "DataCamp Git Chapter 2 - Repositories",
  "Rewinding work", "revert, other undos, checking out old versions, rewriting history", "DataCamp Git Chapter 3 - Undo",
  "Branching", "git checkout, manual merge", "DataCamp Git Chapter 4 - Branches", 
  "Sharing and conflicts", "pull upstream, merge, conflicts, mark resolved", "DataCamp Git Chapter 5 - Collaborating",
  "Testing and Continuous Integration", "Test suites, Travis CI integration, github bots", "https://docs.travis-ci.com/user/for-beginners/ https://docs.travis-ci.com/user/getting-started/",
  "Release management", "github releases, git tag", "https://github.com/blog/1547-release-your-software https://help.github.com/articles/creating-releases/",
  "Documentation and Q&A", "github flavored markdown", "https://guides.github.com/features/mastering-markdown/",
  "Wikipedia Editing", "wiki syntax, referencing", "Wikipedia Student Tutorial: https://en.wikipedia.org/wiki/Wikipedia:Training/For_students",
  "Executable Papers", "rmarkdown, knitr, rstudio", "Datacamp Rmarkdown - Chapter 1",
  "Machine Readable Creative Commons Licenses", "", "https://wiki.creativecommons.org/wiki/Marking_your_work_with_a_CC_license and https://wiki.creativecommons.org/wiki/Best_practices_for_attribution"
) %>% rownames_to_column()
...
content_classes <- full_join(insight_topics, skills_topics, by="rowname") %>% 
  select(skill_topic, insight_topic) %>% 
